...
const estructura = {
  ...
  "Segundo Año": {
    ...
    "Semestre 2": ["cc", "mec", "cn", "dac", "iim", "qm"]
  },
  "Tercer Año": {
    "Semestre 1": ["cmat", "mf", "emi", "tdm", "ing"],
    "Semestre 2": ["mfis", "mm", "tc", "lid", "conv"]
  },
  "Cuarto Año": {
    "Semestre 1": ["tf", "fdp", "mfnf", "eco", "cme"],
    "Semestre 2": ["fm", "pm", "carac", "ge", "corr", "vi"]
  },
  "Quinto Año": {
    "Semestre 1": ["af", "cmet", "prot", "fep", "cpcc", "e1"],
    "Semestre 2": ["sm", "rec", "lsma", "proj", "cgc", "e2"]
  },
  "Sexto Año": {
    "Semestre 1": ["mem"]
  }
...
function crearMalla() {
  ...
  for (const [año, periodos] of Object.entries(estructura)) {
    const bloqueAño = document.createElement("div");
    bloqueAño.classList.add("bloque-año");
    ...
    for (const [periodo, ids] of Object.entries(periodos)) {
      ...
      bloquePeriodo.appendChild(grid);
      bloqueAño.appendChild(bloquePeriodo);
    }
