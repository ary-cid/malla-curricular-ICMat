...
const estructura = {
  ...
  "Primer Año – Trimestre 3": ["a2", "c2", "q2", "f2"],
  "Segundo Año – Semestre 3": ["c3", "edo", "est", "cp", "qai"],
  "Segundo Año – Semestre 4": ["cc", "mec", "cn", "dac", "iim", "qm"],
  "Tercer Año – Semestre 5": ["cmat", "mf", "emi", "tdm", "ing"],
  "Tercer Año – Semestre 6": ["mfis", "mm", "tc", "lid", "conv"],
  "Cuarto Año – Semestre 7": ["tf", "fdp", "mfnf", "eco", "cme"],
  "Cuarto Año – Semestre 8": ["fm", "pm", "carac", "ge", "corr", "vi"],
  "Quinto Año – Semestre 9": ["af", "cmet", "prot", "fep", "cpcc", "e1"],
  "Quinto Año – Semestre 10": ["sm", "rec", "lsma", "proj", "cgc", "e2"],
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", e => {
    const div = e.target;
    if (div.classList.contains("ramo") && !div.classList.contains("bloqueado")) {
